...
public class JsonDecode {
    ...
    public JsonDecode(World world, JSONObject request) {
     ...
     * robot's name. This name is used to return the World object's IRobot object with
     * the matching name.
     *
     * @return      IRobot : If an IRobot object, with the given name value, exists in the World.World.
     *              NULL   : If there is no IRobot object, with the given name value, that exists
     *                       in the world.
     */
    ...
    private String getCommand(JSONObject request) {
        return ((String)request.get("command")).trim();
    }
